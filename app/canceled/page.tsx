      ...
      <main className="container mx-auto py-12 px-4 flex-1 flex items-center justify-center">
        <Card className="w-full max-w-md border-primary/20 shadow-lg shadow-primary/5">
          <CardHeader className="text-center">
            ...
            <CardDescription>Your payment process was canceled. No charges were made.</CardDescription>
          </CardHeader>
          <CardContent className="text-center">
            <p className="text-muted-foreground mb-4">
              If you encountered any issues or have questions about our payment process, please don't hesitate to
